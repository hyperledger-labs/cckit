...
var (
	pattern_AccountService_GetInvokerAddress_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"account", "addresses", "whoami"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_AccountService_GetAddress_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"account", "addresses", "public_key"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_AccountService_GetAccount_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2}, []string{"account", "accounts", "address"}, "", runtime.AssumeColonVerbOpt(true)))
)
