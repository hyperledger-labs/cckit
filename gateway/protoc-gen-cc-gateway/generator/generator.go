...
func (g *Generator) getCCTemplate(f *descriptor.File) (string, error) {
	...
	pkgs := [][]string{
		{"context", "context"},
		{"github.com/hyperledger-labs/cckit/gateway", "cckit_gateway"},
		{"github.com/hyperledger-labs/cckit/router", "cckit_router"},
		{"github.com/hyperledger-labs/cckit/router/param/defparam", "cckit_defparam"},
		{"github.com/hyperledger-labs/cckit/sdk", "cckit_sdk"},
	}
